...
typedef NTSTATUS(*NtAlpcConnectPort)(_Out_ PHANDLE 	PortHandle,
...
typedef NTSTATUS(*ZwConnectPort)(_Out_ PHANDLE 	PortHandle,
	_In_ PUNICODE_STRING 	PortName,
...
typedef NTSTATUS(*NtRequestPort)(HANDLE PortHandle, PLPC_MESSAGE Request);
...
typedef HRESULT(*TFilterGetMessage)(
	HANDLE                 hPort,
...
typedef  HRESULT(*TFilterSendMessage)(
	HANDLE  hPort,
	LPVOID  lpInBuffer,
...
typedef HRESULT(*TFilterConnectCommunicationPort)(
	LPCWSTR               lpPortName,
	DWORD                 dwOptions,
	LPCVOID               lpContext,
	WORD                  wSizeOfContext,
